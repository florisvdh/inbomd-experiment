...
Een concreet voorbeeld van de broncode van dergelijk [@bondNewBookTitle1967] [@Amano2012; @bondNewBookTitle1967] rapport vind je op <https://github.com/inbo/inbomd_examples> onder het mapje [@incollection-a3e3; @DiggleRibeiro2007; @proceedings-e1; @article-double; @booklet-a1; @BlauwdrukVogels] source/inbo\_rapport [@franklin_mapping_2009; @Kish_1965; @inbook-a1e0; @manual-a0]. Hoe zo een rapport er finaal uit kan zien , vind je op <https://inbomd-examples.netlify.com/>
