...
output:
  ...
  bookdown::epub_book:
    ...
    pandoc_args: !expr c("--csl", system.file("research-institute-for-nature-and-forest.csl", package = "INBOmd"))
bibliography: "`r rbbt::bbt_write_bib('rbbt-bibliography.yaml', overwrite = TRUE)`"
---

# INBO rapport met RMarkdown met Bookdown extensie

Een concreet voorbeeld van de broncode van dergelijk rapport vind je op <https://github.com/inbo/inbomd_examples> onder het mapje [@incollection-a3e3] source/inbo\_rapport. Hoe zo een rapport er finaal uit kan zien , vind je op <https://inbomd-examples.netlify.com/>
