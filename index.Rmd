...
output:
  ...
  bookdown::epub_book:
    ...
    pandoc_args: !expr c("--csl", system.file("research-institute-for-nature-and-forest.csl", package = "INBOmd"))
bibliography: [references.json, references.yaml]
---

# INBO rapport met RMarkdown met Bookdown extensie

Een concreet voorbeeld van de broncode van dergelijk rapport vind je op <https://github.com/inbo/inbomd_examples> onder het mapje [@incollection-a3e3; @DiggleRibeiro2007; @proceedings-e1; @article-double; @booklet-a1; @BlauwdrukVogels] source/inbo_rapport [@franklin_mapping_2009; @Kish_1965; @inbook-a1e0; @manual-a0]. Hoe zo een rapport er finaal uit kan zien [@leitão2011; @larocque2015; @reich2018], vind je op <https://inbomd-examples.netlify.com/> [@bivand2013; @bivand2014; @bivand2019][@pebesma2019]
